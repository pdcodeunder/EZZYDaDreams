...
//    NSString *order_price   = @"1";//1分钱测试
    ...
    [packageParams setObject: @"EZZY"           forKey:@"device_info"]; //支付设备号或门店号
...
//    PDLog(@"sdfa  dfa  %@", prePayid);
    ...
    return [[NSMutableDictionary alloc] initWithObjectsAndKeys:[NSString stringWithFormat:@"%ld", last_errcode], @"error", nil];
}
@end