...
- (void)formatString
{
    ...
    CGFloat firstLineHeadIndent = self.firstLineHeadIndent == 0 ? 0.0 : self.firstLineHeadIndent;
    CGFloat headIndent = 0.0;
    CGFloat lineSpeting = self.lineSpacing == 0 ? 15 / 667.0 * kScreenH : self.lineSpacing;
    ...
    CTParagraphStyleSetting settings[] =
    {
        ...
        {kCTParagraphStyleSpecifierLineSpacing, sizeof(CGFloat), &lineSpeting}
    };
